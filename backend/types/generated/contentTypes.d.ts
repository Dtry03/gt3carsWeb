...
export interface ApiProyectoProyecto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    descripcion_completa: Schema.Attribute.RichText;
    descripcion_corta: Schema.Attribute.String;
    fecha_finalizacion: Schema.Attribute.Date;
    galeria_imagenes: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios',
      true
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiSolicitudSolicitud extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    estado: Schema.Attribute.Enumeration<['Nueva', 'En proceso', 'Resuelta']> &
...
export interface ApiVehiculoVehiculo extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    estado: Schema.Attribute.Enumeration<['disponible', 'vendido']> &
