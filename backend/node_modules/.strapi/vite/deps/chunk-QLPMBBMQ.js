...
import {
  LimitsModal
} from "./chunk-5ZJGA3CZ.js";
import {
  useTypedSelector
} from "./chunk-K3TF5Z34.js";
import {
  AssigneeColumn,
  StageColumn,
  getDisplayName
} from "./chunk-X5N2OGVI.js";
import {
  getStageColorByHex
} from "./chunk-3ORAWHOK.js";
import {
...
import {
  ...
  useGetLocalesQuery
} from "./chunk-N4FRJ4M4.js";
import {
  ReleaseActionMenu,
  ReleaseActionOptions
} from "./chunk-GV4HINGV.js";
import {
...
import {
  ...
  usePersistentState,
  useSelectionState
} from "./chunk-JXV4DNOE.js";
import {
  useConfig
} from "./chunk-SHDRY5HA.js";
import {
  AssetSource,
  AssetType,
...
import {
  ...
  reducer,
  reducer2
} from "./chunk-R4Y2UA5F.js";
import {
  pluginId
} from "./chunk-H4GPAAVJ.js";
import {
  useDocumentActions
} from "./chunk-O75T37QT.js";
import {
  buildValidParams,
  useContentManagerContext,
  useDocument,
  useDocumentLayout
} from "./chunk-SM2K5I3W.js";
import {
  renderAdmin
} from "./chunk-45UP4FU3.js";
import {
  useLicenseLimits
} from "./chunk-S7MWHU36.js";
import {
  Table,
  useTable
} from "./chunk-3NIOQIUN.js";
import {
  useField,
  useForm
...
var index2 = {
  register(app) {
    ...
    app.addMenuLink({
      ...
      Component: () => import("./App-GKKOOV36.js"),
      position: 5
    });
    app.registerPlugin({
      id: pluginId,
  ...
  register(app) {
    app.createSettingSection({
    ...
    }, [
      {
        ...
        id: "settings",
        to: "email",
        Component: () => import("./Settings-3XR2REQL.js").then((mod) => ({
...
var admin2 = {
  register(app) {
    app.addMenuLink({
      ...
      Component: () => import("./App-E6A3L7YG.js").then((mod) => ({
        default: mod.Upload
      })),
      position: 4
    });
    app.addSettingsLink("global", {
      ...
      async Component() {
        const { ProtectedSettingsPage } = await import("./SettingsPage-5AJBKITI.js");
        return {
...
var index3 = {
  ...
  bootstrap(app) {
    ...
    app.addSettingsLink("global", {
      ...
      Component: () => import("./SettingsPage-O4LRUWVY.js").then((mod) => ({
        default: mod.ProtectedSettingsPage
      })),
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled("cms-content-releases")) {
      app.addMenuLink({
        ...
        Component: () => import("./App-PYMRNNV3.js").then((mod) => ({
          default: mod.App
        })),
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { ProtectedReleasesSettingsPage } = await import("./ReleasesSettingsPage-HD3USUWD.js");
          return {
      ...
      app.widgets.register([
        {
          ...
          component: async () => {
            const { UpcomingReleasesWidget } = await import("./Widgets-AXRCNRKC.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseContentReleases } = await import("./PurchaseContentReleases-QXVC373D.js");
          return {
  ...
  register(app) {
    ...
    if (window.strapi.features.isEnabled(FEATURE_ID)) {
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { Router } = await import("./router-VIBUTYBG.js");
          return {
            default: Router
          };
        }
      ...
      app.widgets.register((widgets) => [
        ...widgets,
        {
          ...
          component: async () => {
            const { AssignedWidget } = await import("./Widgets-I7C4MAAE.js");
      ...
      app.addSettingsLink("global", {
        ...
        permissions: [],
        async Component() {
          const { PurchaseReviewWorkflows } = await import("./purchase-review-workflows-G3MIY4LO.js");
          return {
...
//# sourceMappingURL=chunk-QLPMBBMQ.js.map
