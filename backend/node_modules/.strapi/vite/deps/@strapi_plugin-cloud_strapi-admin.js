...
function __variableDynamicImportRuntime1__(path) {
  switch (path) {
    case "./translations/en.json":
      return import("./en.json-M7N6TPYF.js");
    case "./translations/es.json":
      return import("./es.json-NIWWIJ2X.js");
    case "./translations/fr.json":
      return import("./fr.json-NHYTEEF6.js");
    case "./translations/it.json":
      return import("./it.json-OQFMCOQ4.js");
    case "./translations/ru.json":
      return import("./ru.json-2YRK6NEJ.js");
    case "./translations/uk.json":
      return import("./uk.json-74FHANZV.js");
    default:
  ...
  register(app) {
    ...
    if (backendURL == null ? void 0 : backendURL.includes("localhost")) {
      app.addMenuLink({
        ...
        Component: async () => {
          const { App } = await import("./App-5WRR2X2V.js");
          return App;
        }
      });
      const plugin = {
