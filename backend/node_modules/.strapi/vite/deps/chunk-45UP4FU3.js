import {
  ...
  QueryClientProvider,
  img
} from "./chunk-ICWRO22X.js";
import {
  ADMIN_PERMISSIONS_CE,
  HOOKS
} from "./chunk-6USKMVGO.js";
import {
  useNpsSurveySettings
} from "./chunk-W5TYOZYN.js";
import {
  GuidedTourContext
} from "./chunk-NJ7KRAGB.js";
import {
  require_pick
} from "./chunk-PO4DORTO.js";
import {
  getBasename
} from "./chunk-QIJGNK42.js";
import {
  useClipboard
} from "./chunk-PUBP6SXU.js";
import {
  useEnterprise
} from "./chunk-UJGUTD3Y.js";
import {
  ADMIN_PERMISSIONS_EE,
  AUDIT_LOGS_DEFAULT_PAGE_SIZE,
  getEERoutes
} from "./chunk-WR277TY5.js";
import {
  Login
} from "./chunk-PABWJEUV.js";
import {
  MemoizedInputRenderer
} from "./chunk-5OLE3XNE.js";
import {
  Form
} from "./chunk-T2H275BP.js";
import {
  Column,
  LayoutContent,
  Logo,
  UnauthenticatedLayout
} from "./chunk-DNR6HF36.js";
import {
  ConfigurationProvider
} from "./chunk-343HBDFX.js";
import {
  require_baseMerge,
  require_createAssigner,
  require_merge,
  require_omit
} from "./chunk-UOJ7ANUC.js";
import {
  require_baseRest
} from "./chunk-TZ4GSDRL.js";
import {
  HistoryProvider
} from "./chunk-RDGCZRH5.js";
import {
  errorsTrads
...
import {
  ...
  create4 as create2,
  create6 as create3
} from "./chunk-TPUIRTUP.js";
import {
  Layouts
} from "./chunk-XBURYK6X.js";
import {
  TrackingProvider,
  useTracking
...
} from "./chunk-4T27DKXG.js";
import {
  useTypedDispatch,
  useTypedSelector,
  useTypedStore
} from "./chunk-N7JCE3H3.js";
import {
  NotificationsProvider,
  useNotification
} from "./chunk-BGOMOG55.js";
import {
  adminApi,
  getFetchClient,
  isBaseQueryError,
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.AUDIT_LOGS) ? [
    {
      path: "audit-logs",
      lazy: async () => {
        const { ProtectedListPage } = await import("./ListPage-RM3QHXIO.js");
        return {
  ...
  ...window.strapi.features.isEnabled(window.strapi.features.SSO) ? [
    {
      path: "single-sign-on",
      lazy: async () => {
        const { ProtectedSSO } = await import("./SingleSignOnPage-4GSKDOD4.js");
        return {
...
var AuthPage = () => {
  ...
  const { hasAdmin } = data ?? {};
  const Login$1 = useEnterprise(Login, async () => (await import("./Login-JRJWDK6P.js")).LoginEE);
  const forms = useEnterprise(FORMS, async () => (await import("./constants-RJLGS2TQ.js")).FORMS, {
...
var ROUTES_CE = [
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-PN2HTRWM.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-UFQBGYBT.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-EB4ZIOEC.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-UA3IPFMA.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditPage } = await import("./EditPage-4UNRKMXG.js");
      return {
        Component: ProtectedEditPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedCreatePage } = await import("./CreatePage-24CREKWR.js");
      return {
        Component: ProtectedCreatePage
      };
    },
  ...
  {
    lazy: async () => {
      const editWebhook = await import("./EditPage-QZLYTLYU.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedListPage } = await import("./ListPage-4QNGMOVI.js");
      return {
        Component: ProtectedListPage
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-LX6TVYR7.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-TKOMXF7N.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditViewPage-EGDOT2PL.js");
      return {
  ...
  {
    lazy: async () => {
      const { ProtectedCreateView } = await import("./CreateView-UYRTDXN7.js");
      return {
        Component: ProtectedCreateView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedListView } = await import("./ListView-3E4FHHFL.js");
      return {
        Component: ProtectedListView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedEditView } = await import("./EditView-5YIWOT3P.js");
      return {
        Component: ProtectedEditView
      };
    },
  ...
  {
    lazy: async () => {
      const { ProtectedInstalledPlugins } = await import("./InstalledPlugins-2BRZJJ6R.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseAuditLogs } = await import("./PurchaseAuditLogs-IX3SNN6R.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseSingleSignOn } = await import("./PurchaseSingleSignOn-M2VVYRT7.js");
      return {
  ...
  {
    lazy: async () => {
      const { PurchaseContentHistory } = await import("./PurchaseContentHistory-BI6XSYD6.js");
      return {
...
var getImmutableRoutes = () => [
  {
    path: "usecase",
    lazy: async () => {
      const { PrivateUseCasePage } = await import("./UseCasePage-DJUKLSMN.js");
      return {
...
var getInitialRoutes = () => [
  {
    index: true,
    lazy: async () => {
      const { HomePage } = await import("./HomePage-LDS6OZJB.js");
      return {
        Component: HomePage
      };
    }
  },
  {
    path: "me",
    lazy: async () => {
      const { ProfilePage } = await import("./ProfilePage-R33QEVK2.js");
      return {
  ...
  },
  {
    path: "marketplace",
    lazy: async () => {
      const { ProtectedMarketplacePage } = await import("./MarketplacePage-V2GAKZ75.js");
      return {
  ...
  },
  {
    path: "settings/*",
    lazy: async () => {
      const { Layout } = await import("./Layout-4F2YCBLW.js");
      return {
        Component: Layout
      };
    },
    children: [
      {
        ...
        lazy: async () => {
          const { ApplicationInfoPage } = await import("./ApplicationInfoPage-J445MK3A.js");
          return {
    ...
    const routes = [
      {
        ...
        children: [
          ...getImmutableRoutes(),
          {
            path: "/*",
            lazy: async () => {
              const { PrivateAdminLayout } = await import("./AuthenticatedLayout-LRUWEESY.js");
              return {
...
function __variableDynamicImportRuntime4__(path) {
  switch (path) {
    case "./translations/ar.json":
      return import("./ar.json-3DTFBFI2.js");
    case "./translations/ca.json":
      return import("./ca.json-7XZCVR7W.js");
    case "./translations/cs.json":
      return import("./cs.json-XUSOFWRE.js");
    case "./translations/de.json":
      return import("./de.json-T4JRMWWG.js");
    case "./translations/dk.json":
      return import("./dk.json-HJHMPFZ5.js");
    case "./translations/en.json":
      return import("./en.json-2YFAZE4I.js");
    case "./translations/es.json":
      return import("./es.json-QAF3B27C.js");
    case "./translations/eu.json":
      return import("./eu.json-L76KI3V6.js");
    case "./translations/fr.json":
      return import("./fr.json-63VOE3PD.js");
    case "./translations/gu.json":
      return import("./gu.json-KW7FRXQS.js");
    case "./translations/he.json":
      return import("./he.json-GFNHZYAO.js");
    case "./translations/hi.json":
      return import("./hi.json-NUT5GQDR.js");
    case "./translations/hu.json":
      return import("./hu.json-33XVAD2Y.js");
    case "./translations/id.json":
      return import("./id.json-7HGKXOUY.js");
    case "./translations/it.json":
      return import("./it.json-Z6YNBOEV.js");
    case "./translations/ja.json":
      return import("./ja.json-HDSVMHJW.js");
    case "./translations/ko.json":
      return import("./ko.json-MJTAWQ7T.js");
    case "./translations/ml.json":
      return import("./ml.json-I4B6RIGH.js");
    case "./translations/ms.json":
      return import("./ms.json-PM6FC5KB.js");
    case "./translations/nl.json":
      return import("./nl.json-6JCTKPWQ.js");
    case "./translations/no.json":
      return import("./no.json-PJUGD7Z2.js");
    case "./translations/pl.json":
      return import("./pl.json-T64T4K5L.js");
    case "./translations/pt-BR.json":
      return import("./pt-BR.json-BHDLSSWA.js");
    case "./translations/pt.json":
      return import("./pt.json-FTB7CYO4.js");
    case "./translations/ru.json":
      return import("./ru.json-IIXALA6N.js");
    case "./translations/sa.json":
      return import("./sa.json-2VEXN7GB.js");
    case "./translations/sk.json":
      return import("./sk.json-WDG5N2NU.js");
    case "./translations/sv.json":
      return import("./sv.json-3TFPCRV2.js");
    case "./translations/th.json":
      return import("./th.json-SY66WRU4.js");
    case "./translations/tr.json":
      return import("./tr.json-WIIVJPRA.js");
    case "./translations/uk.json":
      return import("./uk.json-JG64OI6V.js");
    case "./translations/vi.json":
      return import("./vi.json-BTNRK2AB.js");
    case "./translations/zh-Hans.json":
      return import("./zh-Hans.json-KAQJOZLW.js");
    case "./translations/zh.json":
      return import("./zh.json-MQZ2PFJE.js");
    default:
...
function __variableDynamicImportRuntime3__(path) {
  switch (path) {
    case "./translations/en-GB.js":
      return import("./en-GB-UB6JVLVW.js");
    default:
      return new Promise(function(resolve, reject) {
        (typeof queueMicrotask === "function" ? queueMicrotask : setTimeout)(
          reject.bind(null, new Error("Unknown variable dynamic import: " + path))
    ...
    this.widgets.register([
      {
        ...
        component: async () => {
          const { ProfileWidget } = await import("./Widgets-C2WBIQFJ.js");
      ...
      },
      {
        ...
        component: async () => {
          const { KeyStatisticsWidget } = await import("./Widgets-C2WBIQFJ.js");
      ...
      this.widgets.register([
        {
          ...
          component: async () => {
            const { AuditLogsWidget } = await import("./Widgets-M743DB2X.js");
...
//# sourceMappingURL=chunk-45UP4FU3.js.map
